...
import com.wear.testproject.ui.QRCodeResultActivity;
...
public final class CaptureActivity extends Activity implements
	...
	private void initView() {
		...
		mTvTitle.setText(mContext.getString(R.string.scan));
		mTvLeft.setOnClickListener(this);
	}

	private Context mContext;

	private int mAction = 0 ;// 0: 注册： 1： 新增
	...
	protected void onResume() {
		 ...
		 * true)) { setRequestedOrientation(getCurrentOrientation()); } else {
	...
	private void handleDecodeInternally(Result rawResult,
		...
		Intent intent  = new Intent(mContext,QRCodeResultActivity.class);
