...
import com.wear.testproject.wheel.OnWheelChangedListener;
...
public class WheelDateMain {
	...
	public void initDateTimePicker(int year ,int month ,int day,int h,int m) {
		...
		wv_day.TEXT_SIZE = textSize - 5;
		wv_month.TEXT_SIZE = textSize - 5;
		wv_year.TEXT_SIZE = textSize- 5;
		wv_hours.TEXT_SIZE = textSize- 5;
		wv_mins.TEXT_SIZE = textSize- 5;
