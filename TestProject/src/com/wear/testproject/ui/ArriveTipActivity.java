...
public class ArriveTipActivity extends BaseActivity  implements OnClickListener{
	...
	private void initView() {
		...
		mTvMainInfo.setText(mContext.getString(R.string.arrive));
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_arrive_tip);
		initView();
	}
